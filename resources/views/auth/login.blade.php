            ...
            <div class="con">
                <header class="head-form">
                    ...
                    <div class="field-set">
                        ...
                        <input class="form-input" name="password" type="password" placeholder="password" id="pwd"
                    ...
                    <div class="other">
                        <a class="btn submits frgt-pass">Forgot Password</a>
                        <a href="{{ route('register') }}" class="btn submits sign-up">Quiero registrarme!
